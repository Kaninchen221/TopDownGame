...
void ATopDownGameCharacter::UpdateAnimation()
{
...
void ATopDownGameCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// Cease jumping once touch stopped
	StopJumping();
}

void ATopDownGameCharacter::UpdateCharacter()
{
